      ...
      <div className="container-width">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Professional certifications that demonstrate expertise and commitment to continuous learning.
          </p>
        </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <h4 className="text-lg text-blue-600 font-semibold mb-3">
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    {cert.metadata.issue_date && (
                      <p className="flex items-center gap-2">
                        ...
                        Issued: {formatDate(cert.metadata.issue_date)}
                      </p>
                    )}
                    ...
                    {cert.metadata.credential_id && (
                      <p className="flex items-center gap-2">
                        ...
                        ID: {cert.metadata.credential_id}
                      </p>
                    )}
                  </div>
